        ...
        <div class="card-body info-cards" id="tm-card">
            <div class="row">
                <div class="mb-3 col-md-12">
                    ...
                    <input class="form-control" type="text" id="title_tm" name="title_tm" value="{{$blog['title_tm']}}" autofocus/>
        ...
        <div class="card-body info-cards dnone" id="ru-card">
          <div class="row">
            <div class="mb-3 col-md-12">
              ...
              <input class="form-control" type="text" id="title_ru" name="title_ru" value="{{$blog['title_ru']}}" autofocus/>
{{--              <span class="text-danger">@error('ru_name'){{$message}}@enderror</span>--}}
            </div>
        ...
        <div class="card-body info-cards dnone" id="eng-card">
            <div class="row">
                <div class="mb-3 col-md-12">
                    ...
                    <input class="form-control" type="text" id="title_en" name="title_en" value="{{$blog['title_en']}}" autofocus/>
                    {{--              <span class="text-danger">@error('ru_name'){{$message}}@enderror</span>--}}
                </div>
                <div class="row">
                  <style>
