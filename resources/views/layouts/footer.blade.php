<footer itemscope itemtype="http://schema.org/WPFooter">
    <div class="footer_container row">
        <div class="copyrights col-lg-4 col-12">2017 - <?php echo date('Y'); ?>. Arassa Nusga -
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6 d-flex flex-column  ">
                        <div class="contacts_request">
                            ...
                            <div class="dzin">
                                ...
                                <div class="dzin_icon">
                                    <img src="{{ asset('assets/images/phoneLightBlue.png') }}">
                                </div>
                                <div class="dzin_phone">+993 12 754480</div>
                                <div class="dzin_phone">+993 61 648605</div>
                            </div>
                            <div class="mail">
                                <div class="mail_icon"> <img src="{{ asset('assets/images/doveLightBlue.png') }}"></div>
