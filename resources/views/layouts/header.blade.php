<div class="header-sticky-top ">
    ...
    <div class="header-fixed position-fixed">
        ...
        <div class="contact-info">
            ...
            <div id="menuButton" class="menu-button" data-bs-toggle="modal" data-bs-target="#complexMenuModal" style="">
    ...
    <div class="modal-dialog modal-fullscreen">
            ...
            <div class="modal-body d-flex">
                <div class="block-60 reveal-item" id="reveal-6">
                    ...
                    <div class="big-block-content d-flex flex-column m-auto w-50">
                        <a class="all-services-p no-line" href="/{{ $lang }}/services">{{ __('translate.allServ') }}</a>
                        ...
                        <a class="temp-a no-line" href="/{{ $lang }}/blog" id="linkAddress">https://ltm.studio/</a>
                    </div>
                </div>
                <div class="block-40">
        ...
        <div class="modal-content  desktop-none">
            <div class="modal-body mobile-menu-body ">
                ...
                <p class="phone-mobile-menu-p text-center mt-5">+993 12 75 37 13</p>
                ...
                <div
                    ...
                    <a href="/{{ $lang }}/contacts" class="no-line mobile-menu-url">{{ __('translate.contacts') }}</a>
                </div>
