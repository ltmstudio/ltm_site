...
<p class="regular17 m45">Если вы ищете команду, которая поможет вам создать не только стильный и функциональный веб-сайт, но и запустить
    процветающий интернет-магазин, то вы обратились по адресу.</p>
<p class="regular17 m45">Мы - команда профессионалов, готовых реализовать ваши идеи в онлайн-пространстве. Независимо от того, нужен вам
    простой сайт-визитка или сложный интернет-магазин, мы предлагаем полный спектр услуг – от дизайна до разработки и
    поддержки.</p>
<p class="bold40 m60">Доверьтесь нам, и давайте вместе создадим уникальное и успешное онлайн-пространство для вашего бизнеса</p>
<div class="types-of-sites m60">
    <div class="big-type-card">
        <div class="card-desc">
...
<div class="services_buttons quiz flex-column mx-auto m60">
    ...
    <a href="/{{ $lang }}/services"
        class="btn get-disc-btn no-line mx-auto"><span>{{ __('translate.allServ') }}</span></a>
</div>
